...
import { onPageScale } from '../features/Pdf/CreatePdfSlice'

const Image_Fit = () => {
  const{fit_type}=useSelector(res=>res?.Pdf)
const dispatch=useDispatch()
  return (
   <div className='text-[clamp(0.9375rem,0.7875rem+1.2vw,1.125rem)] min-[450px]:text-[clamp(1.202rem,0.733rem+1.3937vw,1.525rem)] lg:text-[clamp(0.8825rem,0.3191rem+0.6148vw,1.1875rem)]'>
          ...
          <select
            value={fit_type}
             onChange={(e) =>dispatch(onPageScale(e.target.value))}
